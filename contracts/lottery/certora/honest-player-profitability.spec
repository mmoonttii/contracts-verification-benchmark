// For each of the intermediate states `Join1`, `Reveal0`, `Reveal1`, there exists a corresponding non-reverting
...
rule redeem0_nojoin1_pays_out_bet(env e) {
...
rule redeem1_noreveal0_pays_out_pot(env e) {
    require e.msg.value == 0;
...
rule redeem0_noreveal1_pays_out_pot(env e) {
    require e.msg.value == 0;
