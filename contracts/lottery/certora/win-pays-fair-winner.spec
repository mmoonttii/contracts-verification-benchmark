...
// If the honest protocol would result in `expected_winner` to be the winner of the lottery, a non-reverting `win`
// transaction must increase `expected_winner` ETH balance by the pot

/// @custom:run certoraRun versions/Lottery_v1.sol:Lottery versions/lib/EOA.sol --verify Lottery:certora/win-pays-fair-winner.spec --optimistic_loop
rule win_pays_fair_winner {
    env e;
