...
// Assuming player0 and player1 behave as EOAs: for the intermediate state `Join1`, there
...
/// @custom:run certoraRun versions/Lottery_v1.sol:Lottery versions/lib/EOA.sol --verify Lottery:certora/honest-player-profitability-eoa-redeem0-nojoin1.spec --link Lottery:player0=EOA --link Lottery:player1=EOA
rule honest_player_profitability_eoa_redeem0_nojoin1 {
    env e;
